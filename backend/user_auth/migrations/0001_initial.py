    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region='SY')),
                ...
                ('medical_history', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user_auth.medicalhistory')),
            ],
            options={
                'verbose_name': 'user',
